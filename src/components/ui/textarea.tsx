    ...
    return (
      <div>
        ...
        <textarea
          ...
          id={id}
          className={clsx(
            "w-full resize-y rounded-[0.9rem] border bg-[var(--surface-soft)] px-4 py-2.5 text-sm text-[var(--foreground)] outline-none transition-all duration-150 ease-in-out",
