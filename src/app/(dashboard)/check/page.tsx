        ...
        <div className="section-hero">
          <div className="space-y-4">
            <div>
              ...
              <h1 className="mt-3 text-2xl font-semibold text-[#2b303a]">Validation communautaire</h1>
              <p className="mt-1 text-sm text-[#676258]">
                Une question est integree au quiz public apres 50 checks (like, dislike ou proposition de modification).
              </p>
            </div>
            ...
            <div className="rubric-strip">
              ...
              <Link href="/check" className="rubric-link rubric-link-active"><ShieldCheck size={13} />Check</Link>
